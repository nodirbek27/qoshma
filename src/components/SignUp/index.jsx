    ...
    <div>
      ...
      <form className="flex flex-col gap-3">
        <label className="input input-bordered flex items-center gap-2">
          Familiya
          <input type="text" className="grow" placeholder="Nurmamatov" />
        </label>
        <label className="input input-bordered flex items-center gap-2">
          Ism
          <input type="text" className="grow" placeholder="Nodirbek" />
        </label>
        <label className="input input-bordered flex items-center gap-2">
          Sharif
          <input type="text" className="grow" placeholder="Shavkatjon o'g'li" />
        </label>
        {/* Phone */}
        <label className="input input-bordered flex items-center gap-2">
          <svg
